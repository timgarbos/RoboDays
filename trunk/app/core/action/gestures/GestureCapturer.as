package app.core.action.gestures {
	...
	public class GestureCapturer extends Sprite {
		...
		public function getTouchGesture():Array {
			return gesture;
		}
		
		public function startTouchGesture(e):void {
			gesture = new Array();
			var pnt:Point = new Point(e.stageX,e.stageY);
			gesture.push( pnt );
			stage.addEventListener(TouchEvent.MOUSE_MOVE,mouseMoveHandlerTouch);
		}
		
		
		public function mouseMoveHandlerTouch(e:TouchEvent):void {
			gesture.push( new Point(e.stageX,e.stageY) );
		}
		
		public function stopTouchGesture():void {
			stage.removeEventListener(MouseEvent.MOUSE_MOVE,mouseMoveHandlerTouch);
			gesture = normalizer.normalizeGesture(gesture);
		}
