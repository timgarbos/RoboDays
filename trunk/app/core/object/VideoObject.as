package app.core.object {
	...
	public class VideoObject extends RotatableScalable {
		...
		//play_btn.graphics.lineStyle(0, 0x202020);
			...
			play_btn.graphics.moveTo(startx+8, starty+7);
			play_btn.graphics.lineTo(startx+8, starty+7);
			play_btn.graphics.lineTo(startx+28, starty+17);			
			play_btn.graphics.lineTo(startx+8, starty+27);			
			play_btn.graphics.lineTo(startx+8, starty+7);	
			play_btn.graphics.endFill();
			...
			pause_btn.graphics.drawRect(startx+2, starty+2, 100, 100);
			pause_btn.graphics.endFill();			
			//pause_btn.graphics.lineStyle(0, 0x202020);
			pause_btn.graphics.beginFill(0x000000, 0.25);
			pause_btn.graphics.drawRect(startx+9, starty+7, 6, 20);
			pause_btn.graphics.drawRect(startx+19, starty+7, 6, 20);
			pause_btn.graphics.endFill();
